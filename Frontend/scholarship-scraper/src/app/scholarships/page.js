    ...
    <div className="min-h-screen bg-gray-100 flex flex-col items-center p-6">
      ...
      {scholarships && (
        ...
        {Object.entries(scholarships)
          .sort((a, b) => new Date(a[1][2]) - new Date(b[1][2])) // Sorting by date
          .map(([name, details], index) => (
            ...
            >
              ...
              <p className="text-gray-600 mb-4">
                <span className="font-semibold">Due Date:</span> {details[2]} <br />
                <span className="font-semibold">Amount:</span> {details[1]}
              </p>
      
              {/* View Scholarship Link */}
              <a
                href={details[0]}
                target="_blank"
              ...
              <p className="text-sm text-gray-600 mt-4">
                ...
                {details[3] || "No description available."}
              </p>
            </div>
          ))}
      </div>
